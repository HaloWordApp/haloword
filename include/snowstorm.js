...
var snowStorm = (function(window, document) {
  ...
  this.snowColor = '#eaeef2';        // Don't eat (or use?) yellow snow.
...
// this.use3DRotate = false;
  ...
  function checkFontFace() {
    ...
    */
    ...
    return supportAtRule('@font-face { font-family: "font"; src: "http://www.shiyihcc.com/start/wwflakes-webfont.ttf"; }');
    ...
    */
    ...
    text = {
      ...
      value: [
        ...
        "src: url('http://www.shiyihcc.com/start/wwflakes-webfont.eot');",
        "src: local('☺'), url('http://www.shiyihcc.com/start/wwflakes-webfont.woff') format('woff'), url('http://www.shiyihcc.com/start/wwflakes-webfont.ttf') format('truetype');",
        "font-weight: normal;",
        "font-style: normal;"
      ]
    };
    ...
    if (!isIE) {
      ...
      */
      ...
      cssLink.href = 'http://www.shiyihcc.com/start/wwflakes-webfont.css';
...
*/
  ...
  this.snow = function() {
    ...
    if (!isNaN(estimatedFPS) && estimatedFPS !== Infinity) {
      document.getElementById('active').innerHTML = active +' of '+s.flakes.length+' (max active: '+s.flakesMaxActive+'), used: '+used+', waiting: '+waiting+', load: '+parseInt(storm.timing.report()/storm.timing.slowInterval*100)+'%, FPS: ~'+estimatedFPS+', slow: '+(s.timing.wasSlow?'true':'false');
    }
